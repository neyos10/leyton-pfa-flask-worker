...
API Flask locale pour créer et consulter des tâches en base de données. Un worker séparé traite ensuite les tâches en attente.
...
Le worker cherche les tâches `pending`, les passe en `in_progress`, simule un traitement, puis les passe en `done`.
